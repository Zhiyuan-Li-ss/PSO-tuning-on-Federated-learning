        ...
        def init():
            if args.model == 'cnn' and args.dataset == 'cifar':
                ...
                for i in range(forest_num):
                    ...
                    forest.append([para_1,para_2,para_3/100,para_4/10,para_5,para_6/10])
                ...
                print('the number of the forests:', forest_num)
                for h in range(hidden_1[2]):
                    for l in range(lr[2]):
                        for m in range(momentum[2]):
                            for le in range(local_epochs[2]):
                                for f in range(fraction[2]):
                                    para_1 = int(h/hidden_1[2] * (hidden_1[1] - hidden_1[0]) + hidden_1[0])
                                    para_3 = l/lr[2] * (lr[1] - lr[0]) + lr[0]
                                    para_4 = m/momentum[2] * (momentum[1] - momentum[0]) + momentum[0]
                                    para_5 = int(le/local_epochs[2] * (local_epochs[1] - local_epochs[0]) + local_epochs[0])
                                    para_6 = f/fraction[2] * (fraction[1] - fraction[0]) + fraction[0]
